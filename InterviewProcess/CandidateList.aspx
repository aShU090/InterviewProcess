<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CandidateList.aspx.cs" Inherits="InterviewProcess.WebForm2" %>
        ...
        <div>
            <table class="auto-style1">
                <tr>
                    <td>&nbsp;</td>
                    <td>
                        <asp:Label ID="Label1" runat="server" ForeColor="Lime" Text="CANDIDATE LIST"></asp:Label>
                    </td>
                    <td>&nbsp;</td>
                </tr>
                <tr>
